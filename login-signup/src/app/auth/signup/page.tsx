  ...
  return (
    <>
      ...
      <div style={{
        ...
        <h2 style={{ textAlign: 'center', marginBottom: '1.5rem', color: '#764ba2' }}>Signup</h2>
        ...
        <p style={{ marginTop: '1rem', textAlign: 'center' }}>
          Already have an account? <a href="/auth/login" style={{ color: '#764ba2', fontWeight: 'bold' }}>Login here</a>
        </p>
      </div>
